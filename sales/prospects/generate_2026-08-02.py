...
def update_prospect_count_json():
    ...
    try:
        ...
        data = {
            "total_prospects": 96000,
            "generated_today": 0,
            "last_updated": "",
            "previous_count": 0,
            "by_priority": {"A": 38400, "B": 33600, "C": 24000},
            "by_experience": {"senior_6plus": 48000, "mid_3to5": 24000, "new_0to2": 24000}
        }
    
    # Update counts
    previous_count = data.get("total_prospects", 96000)
...
def main():
    ...
    # Read final count for display
    total_count = 97000
    try:
        with open(f"{OUTPUT_DIR}prospect_count.json", 'r') as f:
            pc = json.load(f)
            total_count = pc.get("total_prospects", 97000)
    except:
        pass
